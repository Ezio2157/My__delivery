...
public class Bank {
	...
	public Bank (int _size, double _amount) {
		...
		for (int i=0;i<size;i++) {
			accounts.add (new bank.Account(_amount));
		}
	}
	
	public void addAccount (bank.Account ac) {
		accounts.add(ac);
	}
	...
	public bank.Account getAccount (int i) {
		return accounts.get(i);
	}
	
	public List<bank.Account> getListAccounts () {
		return accounts;
	}
